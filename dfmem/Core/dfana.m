classdef dfana
    ...
    methods (Static)
        ...
        function [Ecb, Evb, Efn, Efp] = calcEnergies(sol)
            ...
            % 计算 n-quasi-Ef 和 p-quasi-Ef
            Efn = zeros(size(n,1), size(n,2)); % 创建一个 n 的全零矩阵

            Efp = zeros(size(n,1), size(n,2)); % 创建一个 p 的全零矩阵 !!!
